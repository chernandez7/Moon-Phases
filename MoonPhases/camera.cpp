...
Camera::Camera(void)
{
	...
	0 UpVec: -0.361001
	0 position: 0.718414
	1 forwardVec: 0.555271
	1 rightVec: 0.463184
	1 UpVec: 0.690746
	1 position: 0.449682
	2 forwardVec: -0.779391
	2 rightVec: 0
	2 UpVec: 0.626531
	2 position: 0.958661 */
	vectorSet(rightVec, 0.886262f, 0.463184f, 0.0f);
	vectorSet(upVec, -0.361001f, 0.690746f, 0.626531f);
	vectorSet(position, 0.718414f, 0.449682f, 0.958661f);
	vectorSet(forwardVec, -0.2902f, 0.555271f, -0.779391f);
}
...
void Camera::setPosition(float* vec) {
	vectorSet(position, vec[0], vec[1], vec[2]);
}